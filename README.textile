...
You can resize them all from the commandline with ImageMagick. For example, let's say your photos are in raw_photos and you'd like to have all be resized to 180 pixels:
